    ...
    <div className="container">
      <div className="header">
        ...
        <div className="header-language-container">
          <div
            className={`header-language ${language === "es" ? "selected" : ""}`}
      ...
      <div className="new-section-container">
        <div className="manifest-container">
          ...
          <div className="manifest-paragraf">
            {language === "es"
              ? "Por lo que se refiere al Ayuntamiento de Oropesa venimos denunciando la falta de transparencia y la aplicación de un PGOU de 1982 que no incluye toda la normativa medioambiental hasta la actualidad."
              : `Pel que fa a l'Ajuntament d'Orpesa hem denunciat la falta de transparència i l'aplicació d'un PGOU de 1982 que no inclou tota la normativa mediambiental fins a l'actualitat.`}
          </div>
          <div className="manifest-paragraf">
            {language === "es"
              ? "También solicitamos la paralización de cualquier obra que se esté ejecutando actualmente en la zona. De acuerdo a la Ley 42/2007, de 13 de diciembre, del Patrimonio Natural y la Biodiversidad, se deberían prohibir todas las obras que alteren el hábitat en los períodos de cría de las especies protegidas, circunstancia que se da en estos momentos."
              : `
          ...
          <div className="manifest-paragraf">
            {language === "es"
              ? "En última instancia, el Ayuntamiento es quien autoriza o no la obra. Apelamos a su compromiso con el conjunto de la ciudadanía y muy especialmente con las generaciones futuras y le solicitamos que utilice todas las herramientas legales existentes y válidas para evitar que este paraje litoral acabe perdiéndose cubierto de pasarelas."
              : `
        ...
        <div className="signing-org">
          <div className="signing-org-title"></div>
          <a target="_blank" href={"https://salvemrenega.org/"}>
            {" "}
            {"Plataforma Salvem la Renegà"}{" "}
          </a>
          <a
            target="_blank"
            href={
              "https://www.ecologistasenaccion.org/federaciones/paisvalencia/castello/vila-real/"
            }
          >
            {" "}
          ...
          <a
            target="_blank"
            href={
              "https://www.ecologistasenaccion.org/federaciones/paisvalencia/castello/vinaros/"
            }
          >
            {" "}
          ...
          <a
            target="_blank"
            href={
              "https://www.ecologistasenaccion.org/federaciones/pais-valencia/castello/la-vall-duixo/"
            }
          >
            {" "}
            {"L’ARQUET-Ecologistes en Acció de la Vall d’Uixó"}{" "}
          </a>
          <a target="_blank" href={"https://www.gecen.net"}>
            {" "}
            {"GECEN-Grup d’Estudis i Conservació dels Espais Naturals"}{" "}
          </a>
          <a target="_blank" href={"https://prodesert.org/"}>
            {" "}
            {"Asociación Ecologista Pro Desert​"}{" "}
          </a>
          <p>Nuevas adhesiones:</p>
          <a target="_blank" href={"https://www.intersindical.org/"}>
            {" "}
          ...
          <a
            target="_blank"
            href={
              "https://www.facebook.com/Xarxa-dAgroecol%C3%B2gia-de-Castell%C3%B3-XAC-117076068318097/"
            }
          >
            {" "}
          ...
          <a
            target="_blank"
            href={"https://www.facebook.com/casalpopularonda/"}
          >
            {" "}
          ...
          <a
            target="_blank"
            href={"https://fridaysforfuturecastello.wordpress.com/vinaros/"}
          >
            {" "}
            {"Fridays for Future - Joventut pel Clima Vinaròs"}{" "}
          </a>
          <a target="_blank" href={"http://www.mascotasenadopcion.es/"}>
            {" "}
            {"Mascotes en Adopció Castelló"}{" "}
          </a>
          <a target="_blank" href={""}>
            {" "}
            {
              "Asociación para la defensa de la Naturaleza de Sierra de Gata Vettonia​"
            }{" "}
          </a>
          <a target="_blank" href={""}>
            {" "}
            {"Maleïdes. Col•lectiu feminista de VIla-real"}{" "}
          </a>
          <a target="_blank" href={"https://www.endavant.org/"}>
            {" "}
            {"Endavant (OSAN)​"}{" "}
          </a>
          <a target="_blank" href={""}>
          ...
          <a target="_blank" href={""}>
            {" "}
            {"UGT-PV Comarques del Nord"}{" "}
          </a>
          <a target="_blank" href={"http://www.periferies.org/"}>
            {" "}
            {"Perifèries del Món"}{" "}
          </a>
          <a target="_blank" href={"https://www.pv.ccoo.es/Comarques_del_Nord"}>
            {" "}
            {"CCOO PV Comarques del Nord​"}{" "}
          </a>
          <a target="_blank" href={"https://comunitatujixplaneta.uji.es/"}>
            {" "}
            {"Comunitat UJIxPlaneta"}{" "}
          </a>
          <a
            target="_blank"
            href={"http://www.carrasca-ecologistesenaccio.org/"}
          >
            {" "}
            {"Colla Ecologista La Carrasca - Ecologistes en Acció"}{" "}
          </a>
          <a target="_blank" href={"http://www.serra-espada.org/"}>
            {" "}
            {"SASE (Societat d´Amics de la Serra Espadà)"}{" "}
          </a>
          <a
            target="_blank"
            href={"https://sites.google.com/site/castelloenbici/"}
          >
            {" "}
            {"Castelló en Bici"}{" "}
          </a>
          <a target="_blank" href={"https://twitter.com/adp_asoc"}>
            {" "}
            {"Associació Amics de Palanques"}{" "}
          </a>
          <a target="_blank" href={"https://www.facebook.com/cuidembeni/"}>
            {" "}
            {"Cuidem Benimaclet"}{" "}
          </a>
          <a target="_blank" href={"http://www.facebook.com/cgtkastello"}>
            {" "}
            {"CGT Castelló"}{" "}
          </a>
          <a target="_blank" href={"https://www.lamaranya.org"}>
            {" "}
            {"Centre de Cultura i Joventut La Maranya"}{" "}
          </a>
          <a target="_blank" href={"https://www.sepc.cat/"}>
            {" "}
          ...
          <a
            target="_blank"
            href={"https://www.facebook.com/muixerangadelaplana/"}
          >
            {" "}
            {"Muixeranga de la Plana"}{" "}
          </a>
          <a target="_blank" href={"http://www.eupv.org/"}>
            {" "}
            {"Esquerra Unida del País Valencià"}{" "}
          </a>
          <a target="_blank" href={"https://twitter.com/Decidim_CN"}>
            {" "}
            {"Decidim-País Valencià"}{" "}
          </a>
          <a
            target="_blank"
            href={"https://www.facebook.com/DefensaPaisajePedralba/"}
          >
            {" "}
            {"En Defensa del Paisaje de Pedralba"}{" "}
          </a>
          <a target="_blank" href={"http://www.ecobetera.es/"}>
            {" "}
            {"Ecobétera"}{" "}
          </a>
          <a target="_blank" href={"https://www.facebook.com/asoc.SURC/"}>
            {" "}
            {"Associació Cultural SURC"}{" "}
          </a>

          <p> Número de adhesiones físicas individuales: 105</p>
        </div>
      </div>
      <div className="contact-container">
        ...
        <div className="contact-title" style={{ display: "flex" }}>
          <div style={{ marginRight: 24 }}>
            {language === "es" ? "Escríbenos a: " : "Escriu-nos a:"}
          </div>
          <a
            style={{ color: "#63B995" }}
            href={"mailto:renegarenega9@gmail.com"}
          >
            {"renegarenega9@gmail.com"}
          </a>
        </div>
        <div className="contact-title">{"o"}</div>
        <div
          className="typeform-widget"
          data-url="https://comunicacion489067.typeform.com/to/WU4fBx"
          style={{
            width: "100%",
            height: "300px",
            borderRadius: "10px",
